...
const std::string ExgPillEmgDataSchemaV1Descriptor::name =
    "ExgPillEmgDataSchemaV1Descriptor";
const uint16_t ExgPillEmgDataSchemaV1Descriptor::descriptorVersion = 1;

namespace {

SchemaFieldDescriptor buildEmgDescriptorRootField() {
  const auto sampleField = std::make_shared<SchemaFieldDescriptor>(
      "sample",
      "Sample",
      FieldValueType::Int16,
      "One signed EMG sample");

  const auto samplesField = SchemaFieldDescriptor(
      "samples",
      "Samples",
      FieldValueType::Array,
      "Per-channel EMG samples",
      std::string{},
      false,
  ...
  return SchemaFieldDescriptor(
      ...
      "EMG Frame",
      FieldValueType::Object,
      "Descriptor for EXG Pill EMG frames",
      std::string{},
      false,
      std::vector<std::string>{},
      std::vector<SchemaFieldDescriptor>{
          ...
          SchemaFieldDescriptor(
              ...
              "Channels",
              FieldValueType::Array,
              "EMG channels carried in this frame",
              std::string{},
              false,
              std::vector<std::string>{},
              std::vector<SchemaFieldDescriptor>{},
...
std::string ExgPillEmgDataSchemaV1Descriptor::getTargetSchemaName() const {
  return ExgPillEmgDataSchemaV1::name;
}

uint16_t ExgPillEmgDataSchemaV1Descriptor::getDescriptorVersion() const {
  return descriptorVersion;
}

const SchemaFieldDescriptor &ExgPillEmgDataSchemaV1Descriptor::getRootField() const {
  static const SchemaFieldDescriptor rootField = buildEmgDescriptorRootField();
  return rootField;
}

Optional<FieldValueRef> ExgPillEmgDataSchemaV1Descriptor::tryGetFieldValue(
    const Schema &record,
  ...
  return FieldValueRef::fromInt16(samples[flattenedIndex]);
}

void ExgPillEmgDataSchemaV1Descriptor::registerWithRegistry(
    DataSchemaDescriptorRegistry &registry) {
  registry.registerDescriptor(
      std::shared_ptr<const DataSchemaDescriptor>(
          new ExgPillEmgDataSchemaV1Descriptor()));
}
