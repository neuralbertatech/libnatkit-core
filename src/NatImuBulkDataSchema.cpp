...
//        }
        ...
        std::unique_ptr<std::vector<uint8_t>>
            ...
            case SerializationType::Binary: {
                const int singleReadingSizeInBytes = 61;
                ...
                for (size_t i = 0; i < NatImuBulkDataSchemaDataArraySize; ++i) {
                    ...
                    dataPointer += Binary::unsafeWriteAsBinaryToArray<uint8_t>(dataPointer, static_cast<uint8_t>(data[i].accuracy));
                }
...
//        }
        ...
        Optional<std::unique_ptr<NatImuBulkDataSchema>> NatImuBulkDataSchema::decodeBinary(const std::vector<uint8_t>& message) {
            ...
            for (int i = 0; i < NatImuBulkDataSchemaDataArraySize; ++i) {
                ...
                bytes += Binary::unsafeParseFromBinary<uint8_t>(bytes, *(uint8_t*)&sensorReading.accuracy);
